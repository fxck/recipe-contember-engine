...
export function getSystemMigrations (): Promise<Migration[]> {
	return loadMigrations(process.env.CONTEMBER_SYSTEM_MIGRATIONS_DIR || dirname(fileURLToPath(import.meta.url)), [
